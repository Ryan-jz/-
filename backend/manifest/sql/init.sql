-- 创建数据库
CREATE DATABASE IF NOT EXISTS `bai_jin_yan` DEFAULT CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci;
...
INSERT INTO `sys_user` VALUES (1, 100, 'admin', '管理员', '00', 'admin@example.com', '15888888888', '0', '', 'e10adc3949ba59abbe56e057f20f883e', '0', '0', '127.0.0.1', NOW(), 'admin', NOW(), '', NULL, '管理员');
