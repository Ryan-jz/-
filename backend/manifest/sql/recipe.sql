...
CREATE TABLE IF NOT EXISTS `recipe` (
  ...
  `product_ids` varchar(500) DEFAULT NULL COMMENT '关联产品ID（逗号分隔）',
...
-- 插入示例数据
INSERT INTO `recipe` (`name`, `name_en`, `subtitle`, `description`, `image`, `ingredients`, `content`, `cooking_time`, `difficulty`, `servings`, `product_ids`, `tags`, `sort_order`, `status`)
VALUES 
('喜马拉雅盐烤鸡', 'Himalayan Salt Roasted Chicken', '外酥里嫩，盐香四溢', '使用喜马拉雅粉盐腌制的烤鸡，肉质鲜嫩多汁，带有独特的矿物质风味', '/uploads/images/recipe-chicken.jpg', 
...
('海盐柠檬烤鱼', 'Sea Salt Lemon Grilled Fish', '清新爽口，营养健康', '采用天然海盐和新鲜柠檬调味的烤鱼，保留鱼肉的鲜美', '/uploads/images/recipe-fish.jpg',
