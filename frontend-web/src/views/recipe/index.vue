    ...
    <main class="main-content">
      <div class="recipe-container">
        <div class="container">
          ...
          <div v-if="activeTab === 'dishes'" class="tag-filters">
            <button 
              v-for="tag in dishTags" 
              :key="tag.value"
              :class="['tag-button', { active: activeTag === tag.value }]"
...
const dishTags = [
  { label: '全部', value: 'all' },
  { label: '鱼类菜肴', value: 'fish' },
  { label: '季节性菜肴', value: 'seasonal' },
  { label: '提供与烘焙', value: 'baking' },
  { label: '儿童菜肴', value: 'kids' },
  { label: '甜点与点心', value: 'dessert' },
  { label: '蔬菜或双新鲜蔬菜', value: 'vegetable' },
  { label: '糖果菜肴', value: 'candy' },
  { label: '轻盈菜肴', value: 'light' },
  { label: '素食', value: 'vegetarian' },
  { label: '纯素和素食', value: 'vegan' }
]

const filteredRecipes = computed(() => {
  let filtered = recipes.value
  
  if (activeTab.value === 'dishes') {
    filtered = filtered.filter(recipe => {
      const tags = recipe.tags || ''
      return tags.includes('dishes')
    })
